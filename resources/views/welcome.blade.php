<x-guest-layout>
    <div class="relative z-10 pt-52 pb-64 bg-cover bg-center" style="background-image: url(/img/hero-bg.jpg)">
        ...
        <div class="container relative z-20 text-white text-center text-2xl">
            <h2 class="font-bold text-5xl mb-8">Lorem ipsum dolor sit, <br> amet consectetur adipisicing elit. Repellendus, reprehenderit.</h2>
    ...
    {{-- <div class="py-32 text-center">
        <div class="container">
            <h2 class="font-bold text-4xl mb-6">Lorem ipsum dolor sit amet consectetur <br> adipisicing elit. Est eos dolores <span class="underline">obcaecati eligendi</span></h2>
            <p class="text-gray-500 text-2xl font-bold mb-10">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Illo at velit nostrum.</p>
            <a href="" class="border-2 border-gray-700 rounded-2xl text-xl px-8 py-3 inline-block">Start the Searching</a>


            <h2 class="font-bold text-4xl mb-6 mt-20">Lorem ipsum dolor sit amet consectetur <br> adipisicing elit. Est eos dolores <span class="underline">obcaecati eligendi</span></h2>
        </div>
    </div> --}}
