<div class="container">
    ...
    {{-- Additional Services --}}
    <div class="pt-20 text-lg border-b-2 border-gray-300 pb-16 mb-16">
        ...
        <div class="flex -mx-4">
            ...
            <div class="flex-1 px-4">
                <a href="" class="underline">Lorem, ipsum dolor ipsum dolor.</a>
            </div>
        </div>
    </div>
...
<img src="/img/footer.jpg" class="w-full" alt="">
